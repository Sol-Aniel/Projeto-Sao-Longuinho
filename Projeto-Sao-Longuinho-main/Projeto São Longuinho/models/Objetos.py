...
class Objetos(db.Model):
    ...
    team = db.Column(db.String(50),db.ForeignKey('equipes.id'), nullable=False, default='')
    ...
    size = db.Column(db.composite(db.Size, db.Float, db.String(5)), nullable=False, default=(0, ''))
    ...
    equipes = db.relationship('Equipes', backpopulates='objetos')
